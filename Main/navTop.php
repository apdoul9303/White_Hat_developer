    ...
    <div class="container-fluid">
      ...
      <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav">
          ...
          <li <?php echo ($index == 2)?'class="active"':'';?>><a href="forum/forum.php?c=1">Forums</a></li>
        ...
        <ul class="nav navbar-nav navbar-right">
          <li>
            <a class='dropdown-trigger btn' href='#' data-target='dropdown1'>
              <img alt="photo" src="<?php echo ($_SESSION['user_img_path'] != NULL)?$_SESSION['user_img_path']:'images/giraffe.jpg';?>" class="<?php echo $_SESSION['user_img_css']."-small";?> dropdown-trigger"/>
            </a>
            <!-- Dropdown Structure -->
