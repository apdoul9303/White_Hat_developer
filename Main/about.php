          ...
          <div class="col-xs-12">
            <div class="row">
              <div class="col-md-6">
                <h1>Contact</h1>
                <p>
                  This website is designed for my MSc dissertation in 2018.<br>
I hope you enjoy the lessons and if you find any issues with this website, please contact me.
                </p>
              </div>
              <div class="col-md-6">
                <h1>Tingyu Liu</h1>
